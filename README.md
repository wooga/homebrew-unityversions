...
```bash
brew cask install unity@2020.1.5f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.5f1
```
...
`unity-android-support-for-editor@2020.1.5f1` --> `/Applications/Unity-2020.1.5f1/PlaybackEngines/`
