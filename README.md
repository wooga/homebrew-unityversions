...
```bash
brew cask install unity@2017.4.20f2
```

-or-

```bash
brew cask install unity-android-support-for-editor@2017.4.20f2
```
...
`unity-android-support-for-editor@2017.4.20f2` --> `/Applications/Unity-2017.4.20f2/PlaybackEngines/`
