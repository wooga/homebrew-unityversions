...
```bash
brew cask install unity@2017.4.32f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2017.4.32f1
```
...
`unity-android-support-for-editor@2017.4.32f1` --> `/Applications/Unity-2017.4.32f1/PlaybackEngines/`
