...
```bash
brew cask install unity@2018.4.21f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.4.21f1
```
...
`unity-android-support-for-editor@2018.4.21f1` --> `/Applications/Unity-2018.4.21f1/PlaybackEngines/`
