...
```bash
brew cask install unity@2018.3.4f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.3.4f1
```
...
`unity-android-support-for-editor@2018.3.4f1` --> `/Applications/Unity-2018.3.4f1/PlaybackEngines/`
