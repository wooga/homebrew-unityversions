...
```bash
brew cask install unity@2017.4.38f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2017.4.38f1
```
...
`unity-android-support-for-editor@2017.4.38f1` --> `/Applications/Unity-2017.4.38f1/PlaybackEngines/`
