...
```bash
brew cask install unity@2018.3.0f2
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.3.0f2
```
...
`unity-android-support-for-editor@2018.3.0f2` --> `/Applications/Unity-2018.3.0f2/PlaybackEngines/`
