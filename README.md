...
```bash
brew cask install unity@2018.2.12f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.2.12f1
```
...
`unity-android-support-for-editor@2018.2.12f1` --> `/Applications/Unity-2018.2.12f1/PlaybackEngines/`
