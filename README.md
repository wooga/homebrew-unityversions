...
```bash
brew cask install unity@2018.2.19f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.2.19f1
```
...
`unity-android-support-for-editor@2018.2.19f1` --> `/Applications/Unity-2018.2.19f1/PlaybackEngines/`
