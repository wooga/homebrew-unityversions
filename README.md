...
```bash
brew cask install unity@2019.2.7f2
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.2.7f2
```
...
`unity-android-support-for-editor@2019.2.7f2` --> `/Applications/Unity-2019.2.7f2/PlaybackEngines/`
