...
```bash
brew cask install unity@2018.2.13f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2018.2.13f1
```
...
`unity-android-support-for-editor@2018.2.13f1` --> `/Applications/Unity-2018.2.13f1/PlaybackEngines/`
