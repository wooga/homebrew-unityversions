...
```bash
brew cask install unity@2019.4.2f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.4.2f1
```
...
`unity-android-support-for-editor@2019.4.2f1` --> `/Applications/Unity-2019.4.2f1/PlaybackEngines/`
