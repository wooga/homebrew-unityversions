...
```bash
brew cask install unity@2020.1.9f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2020.1.9f1
```
...
`unity-android-support-for-editor@2020.1.9f1` --> `/Applications/Unity-2020.1.9f1/PlaybackEngines/`
