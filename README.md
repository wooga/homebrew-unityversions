...
```bash
brew cask install unity@2019.3.12f1
```

-or-

```bash
brew cask install unity-android-support-for-editor@2019.3.12f1
```
...
`unity-android-support-for-editor@2019.3.12f1` --> `/Applications/Unity-2019.3.12f1/PlaybackEngines/`
