cask 'unity-standardassets@2017.4.4f1' do
  version '2017.4.4f1,645c9050ba4d'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/645c9050ba4d/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.4f1/Standard Assets'
end
