cask 'unity-standardassets@2017.4.14f1' do
  version '2017.4.14f1,b28150134d55'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/b28150134d55/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.14f1/Standard Assets'
end
