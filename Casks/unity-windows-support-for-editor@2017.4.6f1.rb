cask 'unity-windows-support-for-editor@2017.4.6f1' do
  ...
  url "https://download.unity3d.com/download_unity/c24f30193bac/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.4.6f1.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-2017.4.6f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.6f1/PlaybackEngines/WindowsStandaloneSupport'
end
