cask 'unity-ios-support-for-editor@2018.1.0f2' do
  ...
  url "https://download.unity3d.com/download_unity/d4d99f31acba/MacEditorTargetInstaller/UnitySetup-iOS-Support-for-Editor-2018.1.0f2.pkg"
  name 'iOS Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-iOS-Support-for-Editor-2018.1.0f2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0f2/PlaybackEngines/iOSSupport'
end
