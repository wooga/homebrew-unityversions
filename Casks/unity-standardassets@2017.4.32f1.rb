cask 'unity-standardassets@2017.4.32f1' do
  version '2017.4.32f1,4da3ed968770'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/4da3ed968770/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.32f1/Standard Assets'
end
