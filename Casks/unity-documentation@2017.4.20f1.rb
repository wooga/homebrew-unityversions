cask 'unity-documentation@2017.4.20f1' do
  version '2017.4.20f1,20968fa45e51'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/20968fa45e51/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.20f1'
end
