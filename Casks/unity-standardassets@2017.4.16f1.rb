cask 'unity-standardassets@2017.4.16f1' do
  version '2017.4.16f1,7f7bdd1ef02b'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/7f7bdd1ef02b/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.16f1/Standard Assets'
end
