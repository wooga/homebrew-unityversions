cask 'unity-webgl-support-for-editor@5.6.0f3' do
  ...
  url "https://download.unity3d.com/download_unity/497a0f351392/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-5.6.0f3.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-5.6.0f3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.0f3/PlaybackEngines/WebGLSupport'
end
