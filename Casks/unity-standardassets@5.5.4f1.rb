cask 'unity-standardassets@5.5.4f1' do
  version '5.5.4f1,8ffd0efd98b1'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/8ffd0efd98b1/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.4f1/Standard Assets'
end
