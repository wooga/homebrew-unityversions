cask 'unity-standardassets@2017.4.12f1' do
  version '2017.4.12f1,b582b87345b1'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/b582b87345b1/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.12f1/Standard Assets'
end
