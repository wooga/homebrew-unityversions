cask 'unity-webgl-support-for-editor@2018.2.5f1' do
  ...
  url "https://download.unity3d.com/download_unity/3071d1717b71/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-2018.2.5f1.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-2018.2.5f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.2.5f1/PlaybackEngines/WebGLSupport'
end
