cask 'unity-documentation@2017.4.32f1' do
  version '2017.4.32f1,4da3ed968770'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/4da3ed968770/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.32f1'
end
