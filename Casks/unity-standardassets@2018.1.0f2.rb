cask 'unity-standardassets@2018.1.0f2' do
  version '2018.1.0f2,d4d99f31acba'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/d4d99f31acba/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0f2/Standard Assets'
end
