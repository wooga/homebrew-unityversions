cask 'unity-standardassets@5.6.1f1' do
  version '5.6.1f1,2860b30f0b54'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/2860b30f0b54/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.1f1/Standard Assets'
end
