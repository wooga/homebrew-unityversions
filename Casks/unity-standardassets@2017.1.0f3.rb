cask 'unity-standardassets@2017.1.0f3' do
  version '2017.1.0f3,472613c02cf7'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/472613c02cf7/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0f3/Standard Assets'
end
