cask 'unity-standardassets@2018.1.8f1' do
  version '2018.1.8f1,26051d4de9e9'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/26051d4de9e9/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.8f1/Standard Assets'
end
