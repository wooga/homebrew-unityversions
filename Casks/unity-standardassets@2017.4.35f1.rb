cask 'unity-standardassets@2017.4.35f1' do
  version '2017.4.35f1,e57a7bcbbf0b'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/e57a7bcbbf0b/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.35f1/Standard Assets'
end
