cask 'unity-standardassets@2017.4.13f1' do
  version '2017.4.13f1,6902ad48015d'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/6902ad48015d/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.13f1/Standard Assets'
end
