cask 'unity-webgl-support-for-editor@2018.2.0f2' do
  ...
  url "https://download.unity3d.com/download_unity/787658998520/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-2018.2.0f2.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-2018.2.0f2.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.2.0f2/PlaybackEngines/WebGLSupport'
end
