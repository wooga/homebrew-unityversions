cask 'unity-linux-support-for-editor@2018.4.5f1' do
  ...
  url "https://download.unity3d.com/download_unity/7b38f8ac282e/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-2018.4.5f1.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-2018.4.5f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.4.5f1/PlaybackEngines/LinuxStandaloneSupport'
end
