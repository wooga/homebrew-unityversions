cask 'unity-documentation@2017.4.23f1' do
  version '2017.4.23f1,f80c8a98b1b5'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/f80c8a98b1b5/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.23f1'
end
