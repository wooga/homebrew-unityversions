cask 'unity-standardassets@2017.4.3f1' do
  version '2017.4.3f1,21ae32b5a9cb'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/21ae32b5a9cb/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.3f1/Standard Assets'
end
