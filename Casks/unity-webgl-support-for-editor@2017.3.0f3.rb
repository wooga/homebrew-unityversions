cask 'unity-webgl-support-for-editor@2017.3.0f3' do
  ...
  url "https://download.unity3d.com/download_unity/a9f86dcd79df/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-2017.3.0f3.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-2017.3.0f3.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.3.0f3/PlaybackEngines/WebGLSupport'
end
