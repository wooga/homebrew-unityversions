cask 'unity-standardassets@2018.1.0f1' do
  version '2018.1.0f1,21784bcc13fa'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/21784bcc13fa/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.0f1/Standard Assets'
end
