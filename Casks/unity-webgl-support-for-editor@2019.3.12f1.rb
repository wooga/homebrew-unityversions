cask 'unity-webgl-support-for-editor@2019.3.12f1' do
  ...
  url "https://download.unity3d.com/download_unity/84b23722532d/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-2019.3.12f1.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-2019.3.12f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2019.3.12f1/PlaybackEngines/WebGLSupport'
end
