cask 'unity-linux-support-for-editor@5.5.5f1' do
  ...
  url "https://download.unity3d.com/download_unity/d875e6967482/MacEditorTargetInstaller/UnitySetup-Linux-Support-for-Editor-5.5.5f1.pkg"
  name 'Linux Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Linux-Support-for-Editor-5.5.5f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.5f1/PlaybackEngines/LinuxStandaloneSupport'
end
