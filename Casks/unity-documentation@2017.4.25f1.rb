cask 'unity-documentation@2017.4.25f1' do
  version '2017.4.25f1,9cba1c3a94f1'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/9cba1c3a94f1/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.25f1'
end
