cask 'unity-documentation@2017.4.22f1' do
  version '2017.4.22f1,eb4bc6fa7f1d'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/eb4bc6fa7f1d/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.22f1'
end
