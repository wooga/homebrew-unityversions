cask 'unity-standardassets@2017.4.2f2' do
  version '2017.4.2f2,52d9cb89b362'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/52d9cb89b362/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.2f2/Standard Assets'
end
