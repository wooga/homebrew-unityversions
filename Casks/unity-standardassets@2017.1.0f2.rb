cask 'unity-standardassets@2017.1.0f2' do
  version '2017.1.0f2,66e9e4bfc850'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/66e9e4bfc850/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.1.0f2/Standard Assets'
end
