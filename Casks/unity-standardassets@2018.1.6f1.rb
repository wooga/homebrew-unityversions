cask 'unity-standardassets@2018.1.6f1' do
  version '2018.1.6f1,57cc34175ccf'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/57cc34175ccf/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.6f1/Standard Assets'
end
