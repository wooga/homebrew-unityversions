cask 'unity-standardassets@5.5.0f3' do
  version '5.5.0f3,38b4efef76f0'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/38b4efef76f0/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.0f3/Standard Assets'
end
