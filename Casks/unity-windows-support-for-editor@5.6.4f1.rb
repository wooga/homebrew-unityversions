cask 'unity-windows-support-for-editor@5.6.4f1' do
  ...
  url "https://download.unity3d.com/download_unity/ac7086b8d112/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-5.6.4f1.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-5.6.4f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.4f1/PlaybackEngines/WindowsStandaloneSupport'
end
