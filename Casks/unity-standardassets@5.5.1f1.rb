cask 'unity-standardassets@5.5.1f1' do
  version '5.5.1f1,88d00a7498cd'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/88d00a7498cd/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.5.1f1/Standard Assets'
end
