cask 'unity-standardassets@2017.4.20f2' do
  version '2017.4.20f2,413dbd19b6dc'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/413dbd19b6dc/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.20f2/Standard Assets'
end
