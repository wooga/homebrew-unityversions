cask 'unity-standardassets@2017.4.1f1' do
  version '2017.4.1f1,9231f953d9d3'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/9231f953d9d3/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.1f1/Standard Assets'
end
