cask 'unity-standardassets@5.6.0f3' do
  version '5.6.0f3,497a0f351392'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/497a0f351392/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.0f3/Standard Assets'
end
