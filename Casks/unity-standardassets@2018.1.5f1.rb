cask 'unity-standardassets@2018.1.5f1' do
  version '2018.1.5f1,732dbf75922d'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/732dbf75922d/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2018.1.5f1/Standard Assets'
end
