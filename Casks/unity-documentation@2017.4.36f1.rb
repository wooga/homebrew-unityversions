cask 'unity-documentation@2017.4.36f1' do
  version '2017.4.36f1,c663def8414c'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/c663def8414c/MacDocumentationInstaller/Documentation.pkg"
  name 'Documentation'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.36f1'
end
