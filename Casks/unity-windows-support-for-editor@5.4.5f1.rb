cask 'unity-windows-support-for-editor@5.4.5f1' do
  ...
  url "https://download.unity3d.com/download_unity/68943b6c8c42/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-5.4.5f1.pkg"
  name 'Windows Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-Windows-Support-for-Editor-5.4.5f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.4.5f1/PlaybackEngines/WindowsStandaloneSupport'
end
