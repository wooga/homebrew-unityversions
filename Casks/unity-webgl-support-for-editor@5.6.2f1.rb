cask 'unity-webgl-support-for-editor@5.6.2f1' do
  ...
  url "https://download.unity3d.com/download_unity/a2913c821e27/MacEditorTargetInstaller/UnitySetup-WebGL-Support-for-Editor-5.6.2f1.pkg"
  name 'WebGL Build Support'
  homepage 'https://unity3d.com/unity/'

  pkg 'UnitySetup-WebGL-Support-for-Editor-5.6.2f1.pkg'
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-5.6.2f1/PlaybackEngines/WebGLSupport'
end
