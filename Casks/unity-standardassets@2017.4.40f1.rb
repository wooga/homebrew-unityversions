cask 'unity-standardassets@2017.4.40f1' do
  version '2017.4.40f1,6e14067f8a9a'
  sha256 :no_check

  url "https://download.unity3d.com/download_unity/6e14067f8a9a/MacStandardAssetsInstaller/StandardAssets.pkg"
  ...
  uninstall quit:    'com.unity3d.UnityEditor5.x',
            delete:  '/Applications/Unity-2017.4.40f1/Standard Assets'
end
